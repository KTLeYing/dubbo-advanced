package com.mzl.dubbocommon.generater;
 ...
 * @Description: 生成mybatis的逆向工程
 * @Author: mzl
 * @CreateDate: 2022/6/10 11:09
 * @Version: 1.0
 */
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/dubbo-advanced?characterEncoding=utf8&useSSL=false&useUnicode=true&serverTimezone=UTC&allowMultiQueries=true");
...
//        gc.setOutputDir(System.getProperty("user.dir" ) + "/src/main/java");
        gc.setOutputDir(System.getProperty("user.dir" ) + "/dubbo-common/src/main/java");
//      gc.setOutputDir(scanner("请输入项目路径") + "/src/main/java");
        ...
        pc.setParent("com.mzl.dubbocommon.generater");
